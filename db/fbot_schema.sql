...
--
-- Table structure for table `stat_threads`
--

DROP TABLE IF EXISTS `stat_threads`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stat_threads` (
  `sid` int(11) DEFAULT NULL,
  `fid` int(11) DEFAULT NULL,
...
-- Dump completed on 2017-11-17  2:19:59
